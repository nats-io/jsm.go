...
func setupConsumerTest(t *testing.T, cb func(t *testing.T, nc *nats.Conn, stream *jsm.Stream, mgr *jsm.Manager)) {
	t.Helper()

	withJSServer(t, func(t *testing.T, nc *nats.Conn, _ *jsm.Manager) {
		t.Helper()

		nc, err := nats.Connect(nc.ConnectedUrl(), nats.UseOldRequestStyle())
...
func TestNextMsg(t *testing.T) {
	setupConsumerTest(t, func(t *testing.T, nc *nats.Conn, stream *jsm.Stream, manager *jsm.Manager) {
...
func TestNewConsumerFromDefaultEphemeral(t *testing.T) {
	setupConsumerTest(t, func(t *testing.T, nc *nats.Conn, stream *jsm.Stream, mgr *jsm.Manager) {
		// interest is needed

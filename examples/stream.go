...
func main() {
	...
	if err = processNextMessage(stream.Name(), consumer.DurableName(), nc); err != nil {
		panic(err)
	}
}
...
func processNextMessage(stream, consumer string, nc *nats.Conn) error {
...
func convertMessage(job *Job) error {

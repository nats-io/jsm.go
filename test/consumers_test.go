...
func setupConsumerTest(t *testing.T, cb func(t testing.TB, nc *nats.Conn, mgr *jsm.Manager, stream *jsm.Stream, i *ntfclient.Instance)) {
...
func TestNextMsg(t *testing.T) {
	setupConsumerTest(t, func(t testing.TB, nc *nats.Conn, mgr *jsm.Manager, stream *jsm.Stream, i *ntfclient.Instance) {
...
func TestConsumer_ClusterInfo_NonClustered(t *testing.T) {
	setupConsumerTest(t, func(t testing.TB, nc *nats.Conn, mgr *jsm.Manager, stream *jsm.Stream, _ *ntfclient.Instance) {
...
func TestConsumerEvacuatePeer(t *testing.T) {
	withJSCluster(t, func(t testing.TB, nc *nats.Conn, mgr *jsm.Manager) {
		...
		err = consumer.EvacuatePeer(evacuated)

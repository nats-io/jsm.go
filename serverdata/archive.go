...
// Archive implements Source by reading from a captured archive.
type Archive struct {
...
// Ipqueuesz reads ipqueuesz data from the archive
func (a *Archive) Ipqueuesz(opts server.IpqueueszEventOptions) ([]*server.ServerAPIpqueueszResponse, error) {
...
// Raftz reads raftz data from the archive
func (a *Archive) Raftz(opts server.RaftzEventOptions) ([]*server.ServerAPIRaftzResponse, error) {
